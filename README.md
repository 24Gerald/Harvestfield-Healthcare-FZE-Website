...
| **3D models** | `public/models/` | Uploadable from the admin panel's **3D models** tab (GLB or glTF, up to 24 MB). Which element a model drives is set in code — see `README.txt` in that folder. |
